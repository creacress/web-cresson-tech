          ...
          <main className={styles.mainContent}>
            ...
            <section className={styles.hero}>
              ...
              <p className={styles.heroText}>
                Offrez à votre entreprise un avantage compétitif grâce à des
                solutions innovantes en intelligence artificielle.
              </p>
              <button
                className={styles.ctaButton}
                onClick={() =>
                  handleClickEvent(
                    "CTA Button - Découvrir nos services",
                    "/services"
                  )
                }
              >
            ...
            <section className={styles.services}>
              ...
              <ul className={styles.servicesList}>
                <li className={styles.serviceItem}>
                  <Link href="/services">
                    ...
                    <div className={styles.serviceContent}>
                      ...
                      <p>
                        Optimisation et extension des systèmes IA pour répondre
                        aux nouveaux défis technologiques.
                      </p>
                    </div>
                ...
                <li className={styles.serviceItem}>
                  <Link href="/services/ia-sur-mesure">
                    ...
                    <div className={styles.serviceContent}>
                      ...
                      <p>
                        Développement de solutions IA personnalisées adaptées à
                ...
                <li className={styles.serviceItem}>
                  <Link href="/services/audit-ia">
                    ...
                    <div className={styles.serviceContent}>
                      ...
                      <p>
                        Analyse approfondie et recommandations pour réussir
                ...
                <li className={styles.serviceItem}>
                  <Link href="/services">
                    ...
                    <div className={styles.serviceContent}>
                      ...
                      <p>
                        Conception et déploiement de modèles d’apprentissage
                ...
                <li className={styles.serviceItem}>
                  <Link href="/services/integration-saas-ia">
                    ...
                    <div className={styles.serviceContent}>
                      ...
                      <p>
                        Amélioration de vos solutions SAAS grâce à l’intégration
                        d’IA.
                      </p>
                    </div>
                ...
                <li className={styles.serviceItem}>
                  <Link href="/services/maintenance-predictive">
                    ...
                    <div className={styles.serviceContent}>
                      ...
                      <p>
                        Support continu pour garantir la performance et la
                        pérennité de vos solutions IA.
                      </p>
                    </div>
